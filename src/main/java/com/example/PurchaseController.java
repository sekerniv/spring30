...
public class PurchaseController {
    ...
    @GetMapping("/{id}")
    public String purchaseForm(@PathVariable int id, Model model, HttpSession session) {
        Book book = null;
    ...
    public String processPurchase(@PathVariable int id,
         ...
         * 1. Sending a redirect with "return 'redirect:/thanks' but that will require also having a ThanksController 
         * 2. returning the template with return 'thanks'
         * 3. making the thanks page static (removing any templating code) and move it to /resources/static/ 
         **/
        return "thanks";
    }
}
